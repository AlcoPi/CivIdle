export const RU = {
   ...
   Pantheon: "Пантеон",
   PantheonDescV2: "Все здания в радиусе 2 Плиток получают +1 к Множителю Производительности Работников и Хранилища. Генерирует науку, равную производству веры всех святилищ",
   Paper: "Бумага",
   ...
   ShowTheoreticalValue: "Показать теоретическое значение",
